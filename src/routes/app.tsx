  ...
  return (
    <div className="min-h-screen flex bg-blanco">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-[14px] font-medium transition-colors ${
                  active ? "bg-blanco/10 text-blanco" : "text-blanco/65 hover:text-blanco hover:bg-blanco/[0.06]"
                }`}
              >
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        <header className="h-[72px] bg-blanco border-b border-crema-dark flex items-center justify-between px-6 lg:px-10">
          <div>
            <div className="label text-savia">Panel del banco</div>
            <div className="font-display font-semibold text-[18px] text-raiz">Banco Arquidiocesano de Alimentos</div>
          </div>
